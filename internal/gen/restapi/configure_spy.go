...
//go:generate swagger generate server --target ../internal/gen --name  --spec ../api/spec.yaml --exclude-main

func configureFlags(api *operations.SpyAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.SpyAPI) http.Handler {
